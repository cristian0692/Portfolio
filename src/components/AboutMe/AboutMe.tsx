...
const AboutMe = () => {
  return (
    ...
    >
      ...
      <div className="flex justify-center items-center gap-10 lg:flex-row flex-col p-5">
        <div className="lg:w-[45%] w-[100%] bg-custom-beige border-5 border-custom-orange p-5 rounded-xl  xl:text-xl md:text-lg text-md flex flex-col gap-3">
          <div>
